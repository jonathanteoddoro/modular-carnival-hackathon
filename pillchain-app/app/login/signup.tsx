    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ThemedView style={styles.formContainer}>
                <ThemedText style={{ fontFamily: "FiraCode_700Bold", fontSize: 32}}>Cadastro</ThemedText>
                <InputOutline placeholder="E-mail *" />
                <InputOutline placeholder="Nome *" />
                <InputOutline placeholder="CPF *" />
                <InputOutline placeholder="Senha *" secureTextEntry />
                <InputOutline placeholder="Confirmar senha *" secureTextEntry />
                <Button color="#434371">

  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto py-12 px-6 md:px-6 lg:px-32">
        ...
        {success && (
          <Alert className="mb-4 bg-green-100 border-green-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6">
                ...
                <a onClick={handleAddMedication} className="text-blue-500 hover:underline cursor-pointer">
            ...
            <div className="flex flex-col justify-between">
              ...
              <p className="text-sm text-gray-500">Endereço: {patientCard || "Não informado"}</p>

              {medications.map((med, index) => (
                <p key={index} className="font-medium">{med.medication} - <span className="font-normal">{med.instructions}</span></p>
              ))}

              <Button className="bg-[#d5a021] text-white mt-16" onClick={issuePrescription} disabled={loading || !isDoctor}>
                <Check className="mr-2 h-5 w-5" />
                {loading ? "Processando..." : "Finalizar receita"}
              </Button>
            </div>
          </div>
        )}
